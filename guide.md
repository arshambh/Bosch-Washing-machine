...
#### 16.4 فعال کردن Wi-Fi روی دستگاه
**شرایط:**
...
**نکته:** برای اطلاعات بیشتر و جزئیات در مورد دسترسی به تشخیص از راه دور در کشور خود، لطفاً به بخش خدمات/پشتیبانی وب‌سایت محلی خود مراجعه کنید: [www.home-connect.com](https://www.home-connect.com).
...
- شناسه منحصر به فرد دستگاه (شامل کدهای دستگاه و همچنین آدرس MAC ماژول ارتباطی Wi-Fi نصب شده).
- گواهی امنیتی ماژول ارتباطی Wi-Fi (برای اطمینان از اتصال داده‌ای امن).
- نسخه فعلی نرم‌افزار و سخت‌افزار دستگاه شما.
- وضعیت هرگونه بازنشانی قبلی به تنظیمات کارخانه.

این ثبت اولیه، عملکردهای Home Connect را برای استفاده آماده می‌کند و فقط زمانی لازم است که بخواهید برای اولین بار از عملکردهای Home Connect استفاده کنید.

توجه: لطفاً توجه داشته باشید که عملکردهای Home Connect فقط با اپلیکیشن Home Connect قابل استفاده هستند. اطلاعات مربوط به حفاظت از داده‌ها را می‌توان در اپلیکیشن Home Connect مشاهده کرد.

![alt text](image-18.png)

### تنظیمات پایه

می‌توانید تنظیمات پایه دستگاه خود را برای برآورده کردن نیازهای خود پیکربندی کنید.

#### 17.1 نمای کلی تنظیمات پایه

**توجه:** ممکن است به دلیل به‌روزرسانی‌های نرم‌افزاری، عملکردهای اضافی در دسترس باشند. اگر به‌روزرسانی نرم‌افزاری موجود باشد، می‌توانید اطلاعات بیشتر را در اپلیکیشن Home Connect پیدا کنید.

| موقعیت | تنظیم پایه | انتخاب | توضیحات |
|--------|-------------|--------|----------|
| 1 | سیگنال پایان | 0 (خاموش) 1 (آرام) 2 (متوسط) 3 (بلند) 4 (خیلی بلند) | تنظیم حجم سیگنال در پایان برنامه. |
| 2 | سیگنال دکمه | 0 (خاموش) 1 (آرام) 2 (متوسط) 3 (بلند) 4 (خیلی بلند) | تنظیم حجم سیگنال صوتی هنگام فشار دادن دکمه‌ها. |
| 3 | روشنایی نمایشگر | 1 (کم) 2 (متوسط) 3 (زیاد) 4 (خیلی زیاد) | تنظیم روشنایی نمایشگر. |
| 5 | یادآوری تمیز کردن درام | روشن خاموش | فعال یا غیرفعال کردن یادآوری برای تمیز کردن درام. |
| 6 | شمارنده برنامه | - | نمایش تعداد برنامه‌های تمام شده. |
| 7 | تنظیمات کارخانه | rES | بازگرداندن دستگاه به تنظیمات کارخانه. |

![alt text](image-19.png)

### 17.2 تغییر تنظیمات پایه

**پیش‌نیاز:** نمایشگر باید تمام دکمه‌های اضافی را نشان دهد.
→ "نمایش یا پنهان کردن دکمه‌های اضافی"، صفحه 19

1. برای فراخوانی تنظیمات پایه، دکمه **تنظیمات پایه** را فشار دهید.
2. تنظیم پایه مورد نظر را انتخاب کنید.
→ "نمای کلی تنظیمات پایه"، صفحه 41
3. برای تغییر مقدار، دکمه‌های `+` یا `-` را فشار دهید.
4. برای بازنشانی دستگاه به تنظیمات کارخانه، دکمه را به مدت حدود 3 ثانیه نگه دارید.
5. برای ذخیره تنظیمات، دکمه **تنظیمات پایه** را فشار دهید.

### 18 شمارنده برنامه

شمارنده برنامه تعداد برنامه‌های تمام شده را نمایش می‌دهد.

#### 18.1 فراخوانی شمارنده برنامه

1. دکمه **تنظیمات پایه** را فشار دهید.
2. برنامه را به موقعیت 6 تنظیم کنید.

### 19 تمیز کردن و سرویس‌دهی

برای اینکه دستگاه شما به مدت طولانی به‌طور کارآمد کار کند، مهم است که آن را به‌طور دقیق تمیز و نگهداری کنید.

#### 19.1 تمیز کردن درام

**احتیاط: خطر آسیب!**
شستشوی مداوم در دماهای پایین و عدم تهویه مناسب دستگاه ممکن است به درام آسیب برساند و باعث آسیب شود.
- به‌طور منظم یک برنامه برای تمیز کردن درام اجرا کنید یا در دماهای حداقل 60 درجه سانتی‌گراد شستشو دهید.
- پس از هر عملیات، دستگاه را با در باز خشک کنید و کشوی مواد شوینده را نیز خشک کنید.
- برنامه **Cottons 90°C** یا برنامه تمیز کردن درام در اپلیکیشن Home Connect را انتخاب کنید.

برنامه را بدون لباس و با استفاده از پودر شستشویی که حاوی سفیدکننده است اجرا کنید.

![alt text](image-20.png)

### 19.2 تمیز کردن کشوی مواد شوینده

اگر می‌خواهید مواد شوینده مایع یا نرم‌کننده پارچه را در محفظه با محصول دیگری جایگزین کنید یا اگر کشوی مواد شوینده کثیف است، کشوی مواد شوینده را تمیز کنید.

**توجه!**
واحد پمپ شامل قطعات الکتریکی است. قطعات الکتریکی ممکن است در صورت تماس با مایعات آسیب ببینند.
- واحد پمپ را در ماشین ظرفشویی تمیز نکنید و آن را در آب غوطه‌ور نکنید.
- اتصال الکتریکی در پشت را در برابر آب، مواد شوینده و باقی‌مانده نرم‌کننده پارچه محافظت کنید.

#### مراحل تمیز کردن کشوی مواد شوینده

1. دستگاه را در حالت آماده به کار قرار دهید.
   → "قرار دادن دستگاه در حالت آماده به کار"، صفحه 34
2. کشوی مواد شوینده را بیرون بکشید.
3. بر روی درج فشار دهید و کشوی مواد شوینده را خارج کنید.
4. واحد پمپ را بردارید.
5. پوشش کشوی مواد شوینده را باز کرده و آن را بردارید.
6. کشوی مواد شوینده را خالی کنید.

![alt text](image-21.png)

7. واحد پمپ را با یک پارچه مرطوب تمیز کنید.
8. کشوی مواد شوینده و درپوش آن را با یک پارچه نرم و مرطوب یا دوش دستی تمیز کنید.
9. کشوی مواد شوینده، درپوش و واحد پمپ را خشک کرده و دوباره در جای خود قرار دهید.
10. محفظه کشوی مواد شوینده در دستگاه را تمیز کنید.
11. کشوی مواد شوینده را به داخل فشار دهید.

#### تمیز کردن پمپ تخلیه
پمپ تخلیه را به طور منظم، حداقل یک بار در سال، و همچنین در صورت بروز مشکلاتی مانند انسداد یا صداهای غیرعادی تمیز کنید.

#### خالی کردن پمپ تخلیه
1. شیر آب را ببندید.
2. دستگاه را در حالت آماده به کار قرار دهید.
   → "قرار دادن دستگاه در حالت آماده به کار"، صفحه 34
3. دوشاخه دستگاه را از پریز برق جدا کنید.


![alt text](image-22.png)


4. درپوش سرویس را باز کرده و بردارید.
5. یک ظرف به اندازه کافی بزرگ زیر دهانه قرار دهید.
6. شلنگ تخلیه را از نگهدارنده خارج کنید.
7. **احتیاط - خطر سوختگی!**
   هنگام شستشو در دماهای بالا، محلول مواد شوینده داغ می‌شود.
   ▶ به محلول داغ مواد شوینده دست نزنید.
   برای اینکه محلول مواد شوینده به داخل ظرف جریان یابد، درپوش آب‌بندی را بردارید.
8. درپوش آب‌بندی را محکم فشار دهید.
9. شلنگ تخلیه را به نگهدارنده برگردانید.
...
#### تمیز کردن پمپ تخلیه
**نیازمندی:** پمپ تخلیه خالی باشد. → صفحه 44

1. از آنجا که ممکن است آب در پمپ تخلیه باقی مانده باشد، درپوش پمپ را با دقت باز کنید.
   ‒ فیلتر داخل محفظه پمپ ممکن است به دلیل ذرات درشت کثیفی گیر کرده باشد. کثیفی‌ها را شل کرده و فیلتر را بردارید.
2. داخل پمپ، رزوه‌های درپوش پمپ و محفظه پمپ را تمیز کنید.
   ‒ درپوش پمپ از دو قسمت تشکیل شده که می‌توان آن‌ها را برای تمیز کردن جدا کرد.
3. اطمینان حاصل کنید که هر دو پروانه می‌توانند بچرخند.
4. درپوش پمپ را وارد کنید.
   ‒ اطمینان حاصل کنید که قسمت‌های درپوش پمپ به درستی مونتاژ شده‌اند.
5. درپوش پمپ را تا جایی که ممکن است بچرخانید.
   ‒ دسته درپوش پمپ باید در موقعیت عمودی باشد.


![alt text](image-24.png)

6. درپوش سرویس را وارد کرده و ببندید.

#### تمیز کردن دهانه ورودی در واشر لاستیکی
به طور منظم دهانه ورودی در واشر لاستیکی را برای هرگونه انسداد بررسی کرده و تمیز کنید.

1. درب دستگاه را باز کنید.
2. هرگونه انسداد را از دهانه ورودی بردارید.
   **توجه:** از اشیاء تیز یا نوک‌تیز استفاده نکنید.

![alt text](image-25.png)


### 20 عیب‌یابی
شما می‌توانید خودتان مشکلات جزئی دستگاه را برطرف کنید. قبل از تماس با خدمات پس از فروش، اطلاعات عیب‌یابی را مطالعه کنید تا از هزینه‌های غیرضروری جلوگیری شود.

**هشدار**
**خطر برق‌گرفتگی!**
تعمیرات نادرست خطرناک هستند.
▶ تعمیرات دستگاه باید فقط توسط کارکنان متخصص آموزش‌دیده انجام شود.
▶ هنگام تعمیر دستگاه، فقط از قطعات یدکی اصلی استفاده کنید.
▶ اگر سیم برق این دستگاه آسیب دیده است، باید توسط سازنده، خدمات مشتریان سازنده یا فردی با صلاحیت مشابه تعویض شود تا از هرگونه خطر جلوگیری شود.

#### خطاها و راه‌حل‌ها

**نمایشگر خاموش شده و چشمک می‌زند.**
- **علت:** حالت صرفه‌جویی در انرژی فعال است.
  - **راه‌حل:** دکمه (Start/Reload) را فشار دهید.
    - نماد دوباره روشن می‌شود.

**"E:30 / -80"**
- **علت:** لوله تخلیه یا شلنگ خروجی آب مسدود شده است.
  - **راه‌حل:** لوله تخلیه و شلنگ خروجی آب را تمیز کنید.
- **علت:** لوله تخلیه یا شلنگ تخلیه آب گیر کرده یا خم شده است.
  - **راه‌حل:** اطمینان حاصل کنید که لوله تخلیه و شلنگ تخلیه آب خم نشده یا گیر نکرده باشند.
- **علت:** شلنگ خروجی آب خیلی بالا نصب شده است.
  - **راه‌حل:** شلنگ خروجی آب را در ارتفاع حداکثر 1 متر نصب کنید.
- **علت:** افزونه غیرمجاز روی شلنگ تخلیه آب نصب شده است.
  - **راه‌حل:** هرگونه افزونه غیرمجاز را از شلنگ آب بردارید.
    - → "اتصال دستگاه"، صفحه 14
- **علت:** پمپ تخلیه مسدود شده است.
  - **راه‌حل:** → "تمیز کردن پمپ تخلیه"، صفحه 44
- **علت:** درپوش پمپ به درستی مونتاژ نشده است.
  - **راه‌حل:** درپوش پمپ را به درستی مونتاژ کنید.
- **علت:** درپوش پمپ به طور کامل پیچ نشده است.
  - **راه‌حل:** اطمینان حاصل کنید که درپوش پمپ به طور کامل در دستگاه پیچ شده است. دسته درپوش پمپ باید در موقعیت عمودی باشد.
- **علت:** دوز مواد شوینده خیلی زیاد است.
...
**"E:30 / -80"**
- **اقدام فوری:** یک قاشق غذاخوری نرم‌کننده پارچه را با 0.5 لیتر آب مخلوط کرده و مخلوط را داخل محفظه دوز دستی بریزید (برای لباس‌های بیرونی، لباس‌های ورزشی یا اقلام پر شده با پر استفاده نکنید).
  - **اگر دوز هوشمند فعال است، دوز پایه را کاهش دهید** → صفحه 37.
  - **اگر به صورت دستی دوز می‌زنید، مقدار مواد شوینده را برای چرخه شستشوی بعدی با همان بار کاهش دهید.**

**"E:38 / -25 / -26"**
- **علت:** پمپ تخلیه مسدود شده است.
  - **راه‌حل:** → "تمیز کردن دیگ"، صفحه 42
  - اگر خطا دوباره نمایش داده شد:
    - → "تمیز کردن پمپ تخلیه"، صفحه 44
- **علت:** دهانه ورودی واشر لاستیکی مسدود شده است.
  - **راه‌حل:** → "تمیز کردن دهانه ورودی در واشر لاستیکی"، صفحه 47

**"E:10 / -00 / -10 / -20"**
- **علت:** پمپ سیستم دوز هوشمند مسدود شده است.
  1. دستگاه را خاموش کنید.
  2. واحد پمپ را تمیز کنید.
     - → "تمیز کردن کشوی مواد شوینده"، صفحه 43
  3. دستگاه را روشن کنید.
  4. اگر پس از تمیز کردن واحد پمپ، دوباره نمایشگر ظاهر شد، با خدمات مشتریان تماس بگیرید.
     - → "خدمات مشتریان"، صفحه 61
  - **توجه:** می‌توانید سیستم دوز هوشمند را غیرفعال کرده و به صورت دستی دوز بزنید تا خطا برطرف شود.
    - → "دکمه‌ها"، صفحه 24

**"H:32"**
- **علت:** سیستم تشخیص بار نامتعادل چرخه چرخش را متوقف کرده زیرا لباس‌ها به طور نامتوازن توزیع شده‌اند.
  - **راه‌حل:** لباس‌ها را در داخل دیگ دوباره توزیع کنید.
  - **توجه:** در صورت امکان، لباس‌های بزرگ و کوچک را در دیگ مخلوط کنید. اقلام با اندازه‌های مختلف بهتر در طول چرخه چرخش توزیع می‌شوند.

**"E:30 / -10" و/یا**
- **علت:** فشار آب کم است.
  - **راه‌حل:** هیچ اقدام اصلاحی ممکن نیست.
- **علت:** فیلتر در ورودی آب مسدود شده است.
  - **راه‌حل:** فیلتر ورودی آب را تمیز کنید.
- **علت:** شیر آب بسته است.
  - **راه‌حل:** شیر آب را باز کنید.
...
**"E:30 / -10" و/یا**
- **علت:** شلنگ ورودی آب خم شده یا گیر کرده است.
  - **راه‌حل:** اطمینان حاصل کنید که شلنگ ورودی آب خم نشده یا گیر نکرده باشد.
- **علت:** سیستم اندازه‌گیری سطح آب معیوب است.
  - **توجه:** با نمایش این پیام خطا، دستگاه فرآیند تخلیه را شروع می‌کند.
    1. ابتدا حدود 5 دقیقه صبر کنید تا فرآیند تخلیه به پایان برسد.
    2. برای بازنشانی پیام خطا، دستگاه را خاموش کنید.
    3. دستگاه را دوباره روشن کنید.
    4. اگر پیام خطا دوباره نمایش داده شد، با خدمات مشتریان تماس بگیرید.
       - → "خدمات مشتریان"، صفحه 61

**"E:35 / -10"**
- **علت:** آب در محفظه پایه وجود دارد.
  - **راه‌حل:** شیر آب را ببندید.
  - **راه‌حل:** با خدمات پس از فروش تماس بگیرید.
    - → "خدمات مشتریان"، صفحه 61
- **علت:** دستگاه نشتی دارد.
  - **راه‌حل:** شیر آب را ببندید.
  - **راه‌حل:** با خدمات پس از فروش تماس بگیرید.
    - → "خدمات مشتریان"، صفحه 61

**علت‌های دیگر:**
- **کشوی مواد شوینده به طور کامل وارد نشده است.**
  - **راه‌حل:** کشوی مواد شوینده را تا زمانی که نماد خاموش شود، به داخل فشار دهید.
- **واحد پمپ وارد نشده است.**
  1. واحد پمپ را داخل کشوی مواد شوینده قرار دهید.
     - → "تمیز کردن کشوی مواد شوینده"، صفحه 43
  2. کشوی مواد شوینده را تا زمانی که نماد خاموش شود، به داخل فشار دهید.
- **دوز مواد شوینده خیلی زیاد است.**
  - **اقدام فوری:** یک قاشق غذاخوری نرم‌کننده پارچه را با 0.5 لیتر آب مخلوط کرده و مخلوط را داخل محفظه دوز دستی بریزید (برای لباس‌های بیرونی، لباس‌های ورزشی یا اقلام پر شده با پر استفاده نکنید).
  - **اگر دوز هوشمند فعال است، دوز پایه را کاهش دهید** → صفحه 37.
  - **اگر به صورت دستی دوز می‌زنید، مقدار مواد شوینده را برای چرخه شستشوی بعدی با همان بار کاهش دهید.**
...
**"E:30 / -20"**
- **علت:** دوز مواد شوینده خیلی زیاد است.
  - **راه‌حل:** اگر به صورت دستی دوز می‌زنید، مقدار مواد شوینده را برای چرخه شستشوی بعدی با همان بار کاهش دهید.
- **علت:** آب اضافی اضافه شده است.
  - **راه‌حل:** در حین کار دستگاه، آب اضافی به آن اضافه نکنید.
- **علت:** شیر برقی معیوب است.
  - **راه‌حل:** با خدمات پس از فروش تماس بگیرید.
    - → "خدمات مشتریان"، صفحه 61

**سایر کدهای خطا**
- **علت:** نقص عملکرد
  1. دستگاه را خاموش و سپس روشن کنید.
  2. اگر پیام دوباره ظاهر شد، دستگاه را حداقل به مدت 30 ثانیه از منبع برق جدا کنید (با کشیدن دوشاخه یا خاموش کردن فیوز مربوطه در جعبه فیوز).
     - اگر خطا یک‌بار رخ داده باشد، پیام ناپدید می‌شود.
  3. اگر پیام دوباره ظاهر شد، با خدمات پس از فروش تماس بگیرید. لطفاً هنگام تماس، پیام خطای دقیق را مشخص کنید.
     - → "خدمات مشتریان"، صفحه 61

**دستگاه کار نمی‌کند.**
- **علت:** دوشاخه برق به پریز وصل نشده است.
  - **راه‌حل:** دستگاه را به منبع برق وصل کنید.
- **علت:** فیوز در جعبه فیوز قطع شده است.
  - **راه‌حل:** فیوز در جعبه فیوز را بررسی کنید.
- **علت:** قطع برق رخ داده است.
  - **راه‌حل:** بررسی کنید که آیا چراغ‌های آشپزخانه یا سایر دستگاه‌ها کار می‌کنند.

**برنامه شروع نمی‌شود.**
- **علت:** دکمه شروع را فشار نداده‌اید.
  - **راه‌حل:** دکمه شروع را فشار دهید.
- **علت:** درب بسته نیست.
  - **راه‌حل:** درب را ببندید.
- **علت:** قفل کودک فعال است.
  - **راه‌حل:** قفل کودک را غیرفعال کنید.
    - → "غیرفعال کردن قفل کودک"، صفحه 35
- **علت:** گزینه "پایان در" فعال است.
  - **راه‌حل:** بررسی کنید که آیا گزینه "پایان در" فعال است.
    - → "دکمه‌ها"، صفحه 25
- **علت:** لباس‌ها در درب گیر کرده‌اند.
  - **راه‌حل:** لباس‌های گیر کرده را بردارید.
- **علت:** کشوی مواد شوینده به طور کامل وارد نشده است.
  - **راه‌حل:** کشوی مواد شوینده را تا زمانی که نماد خاموش شود، به داخل فشار دهید.
...
**درب باز نمی‌شود.**
- **علت:** حالت "نگه‌داشتن شستشو" فعال است.
  - **راه‌حل:** برنامه را با انتخاب گزینه "چرخش" یا "تخلیه" و فشار دادن دکمه ادامه دهید.
    - → "ادامه برنامه در حالت نگه‌داشتن شستشو"، صفحه 34
- **علت:** دما خیلی بالا است.
  - **راه‌حل:** صبر کنید تا دما کاهش یابد.
  - **راه‌حل:** برنامه را لغو کنید.
    - → "لغو برنامه"، صفحه 34
- **علت:** سطح آب خیلی بالا است.
  - **راه‌حل:** یک برنامه مناسب برای تخلیه انتخاب کنید.
    - → "برنامه‌ها"، صفحه 27
- **علت:** قطع برق.
  - **راه‌حل:** درب را با استفاده از آزادسازی اضطراری باز کنید.
    - → "آزادسازی اضطراری"، صفحه 60
...
**آب وارد نمی‌شود. مواد شوینده توزیع نمی‌شود.**
- **علت:** دکمه شروع را فشار نداده‌اید.
  - **راه‌حل:** دکمه شروع را فشار دهید.
- **علت:** فیلتر در ورودی آب مسدود شده است.
  - **راه‌حل:** فیلتر ورودی آب را تمیز کنید.
...
**چرخه چرخش چندین بار اجرا می‌شود.**
- **علت:** سیستم تشخیص بار نامتعادل با توزیع مجدد لباس‌ها، عدم تعادل را برطرف می‌کند.
  - **راه‌حل:** این یک خطا نیست – نیازی به اقدام نیست.
  - **توجه:** هنگام بارگذاری، در صورت امکان، لباس‌های بزرگ و کوچک را با هم در دیگ قرار دهید. اقلام با اندازه‌های مختلف بهتر در طول چرخه چرخش توزیع می‌شوند.
...
**مدت زمان برنامه در طول چرخه شستشو تغییر می‌کند.**
- **علت:** عملکرد برنامه به صورت الکترونیکی بهینه‌سازی می‌شود. این ممکن است مدت زمان برنامه را تغییر دهد.
  - **راه‌حل:** این یک خطا نیست – نیازی به اقدام نیست.
- **علت:** سیستم تشخیص بار نامتعادل با توزیع مجدد لباس‌ها، عدم تعادل را برطرف می‌کند.
  - **راه‌حل:** این یک خطا نیست – نیازی به اقدام نیست.
  - **توجه:** هنگام بارگذاری، در صورت امکان، لباس‌های بزرگ و کوچک را با هم در دیگ قرار دهید. اقلام با اندازه‌های مختلف بهتر در طول چرخه چرخش توزیع می‌شوند.
- **علت:** سیستم تشخیص کف یک چرخه شستشو را فعال می‌کند اگر تجمع کف خیلی زیاد باشد.
  - **راه‌حل:** این یک خطا نیست – نیازی به اقدام نیست.

**آب در دیگ قابل مشاهده نیست.**
- **علت:** آب زیر ناحیه قابل مشاهده است.
  - **راه‌حل:** این یک خطا نیست – نیازی به اقدام نیست.
  - **راه‌حل:** در حین کار دستگاه، آب اضافی به آن اضافه نکنید.

**دیگ پس از شروع برنامه تکان می‌خورد.**
- **علت:** این به دلیل تست داخلی موتور است.
  - **راه‌حل:** این یک خطا نیست – نیازی به اقدام نیست.

**لرزش و حرکت دستگاه در حین چرخش.**
- **علت:** دستگاه به درستی تراز نشده است.
  - **راه‌حل:** → "تراز کردن دستگاه"، صفحه 15
- **علت:** پایه‌های دستگاه ثابت نشده‌اند.
  - **راه‌حل:** پایه‌های دستگاه را ثابت کنید.
    - → "تراز کردن دستگاه"، صفحه 15
- **علت:** پیچ‌های حمل و نقل برداشته نشده‌اند.
  - **راه‌حل:** → "برداشتن پیچ‌های حمل و نقل"، صفحه 13

**دیگ می‌چرخد، آب وارد نمی‌شود.**
- **علت:** تشخیص بار فعال است.
  - **راه‌حل:** این یک خطا نیست – نیازی به اقدام نیست.
  - **توجه:** تشخیص بار ممکن است تا دو دقیقه طول بکشد.
...
**i-DOS 1 و i-DOS 2 قابل فعال‌سازی نیستند.**
- **علت:** دوز هوشمند برای این برنامه در نظر گرفته نشده است.
  - **راه‌حل:** این یک خطا نیست – نیازی به اقدام نیست.
    - → "شروع برنامه با سیستم دوز هوشمند"، صفحه 35
- **علت:** پیشرفت برنامه اجازه دوز هوشمند را نمی‌دهد.
  - **راه‌حل:** هیچ اقدام اصلاحی ممکن نیست.

**سرعت چرخش بالا به دست نمی‌آید.**
- **علت:** سرعت چرخش پایین انتخاب شده است.
  - **راه‌حل:** دفعه بعد که چرخه شستشو را اجرا می‌کنید، سرعت چرخش بالاتری تنظیم کنید.
- **علت:** سیستم تشخیص بار نامتعادل از سرعت چرخش کاهش‌یافته برای برطرف کردن عدم تعادل استفاده می‌کند.
  - **راه‌حل:** لباس‌ها را در داخل دیگ دوباره توزیع کنید.
    - **توجه:** در صورت امکان، لباس‌های بزرگ و کوچک را با هم در دیگ قرار دهید. اقلام با اندازه‌های مختلف بهتر در طول چرخه چرخش توزیع می‌شوند.
  - **راه‌حل:** برنامه "چرخش" را شروع کنید.

**برنامه چرخش شروع نمی‌شود.**
- **علت:** لوله تخلیه یا شلنگ خروجی آب مسدود شده است.
  - **راه‌حل:** لوله تخلیه و شلنگ خروجی آب را تمیز کنید.
- **علت:** لوله تخلیه یا شلنگ تخلیه آب گیر کرده یا خم شده است.
  - **راه‌حل:** اطمینان حاصل کنید که لوله تخلیه و شلنگ تخلیه آب خم نشده یا گیر نکرده باشند.
...
**صدای شتاب‌دار و هیس‌هیس.**
- **علت:** آب با فشار به داخل کشوی مواد شوینده شسته می‌شود.
  - **راه‌حل:** این یک خطا نیست – صدای عادی عملکرد است.

**صدای وزوز طولانی قبل از شروع چرخه شستشو یا نرم‌کننده.**
- **علت:** سیستم دوز هوشمند مواد شوینده یا محصولات مراقبتی را توزیع می‌کند.
  - **راه‌حل:** این یک خطا نیست – صدای عادی عملکرد است.

**صدای وزوز کوتاه پس از روشن کردن دستگاه.**
- **علت:** سیستم دوز هوشمند یک تست عملکرد انجام می‌دهد.
  - **راه‌حل:** این یک خطا نیست – صدای عادی عملکرد است.
...
**صدای ضربه و لرزش در پمپ تخلیه.**
- **علت:** اجسام خارجی وارد پمپ تخلیه شده‌اند.
  - **راه‌حل:** → "تمیز کردن پمپ تخلیه"، صفحه 44

**صدای مکش ریتمیک و شلپ‌شلپ.**
- **علت:** پمپ تخلیه فعال است و محلول مواد شوینده را پمپاژ می‌کند.
  - **راه‌حل:** این یک خطا نیست – صدای عادی عملکرد است.

**چروک شدن لباس‌ها.**
- **علت:** سرعت چرخش خیلی بالا است.
  - **راه‌حل:** دفعه بعد که چرخه شستشو را اجرا می‌کنید، سرعت چرخش پایین‌تری تنظیم کنید.
- **علت:** بار لباس‌ها خیلی زیاد است.
  - **راه‌حل:** دفعه بعد که چرخه شستشو را اجرا می‌کنید، مقدار لباس‌های بارگذاری شده را کاهش دهید.
- **علت:** برنامه نامناسب برای نوع پارچه انتخاب شده است.
  - **راه‌حل:** برنامه‌های مناسب برای نوع پارچه را انتخاب کنید.

**نتیجه چرخش رضایت‌بخش نیست. لباس‌ها خیلی خیس/خیلی مرطوب هستند.**
- **علت:** سرعت چرخش پایین انتخاب شده است.
  - **راه‌حل:** دفعه بعد که چرخه شستشو را اجرا می‌کنید، سرعت چرخش بالاتری تنظیم کنید.
  - **راه‌حل:** برنامه "چرخش" را شروع کنید.
- **علت:** لوله تخلیه یا شلنگ خروجی آب مسدود شده است.
...
**باقی‌مانده مواد شوینده روی لباس‌های مرطوب.**
- **علت:** مواد شوینده ممکن است حاوی مواد نامحلول در آب باشند که روی لباس‌ها رسوب می‌کنند.
  - **راه‌حل:** برنامه "آبکشی" را شروع کنید.
- **علت:** مواد شوینده نامناسب به محفظه سیستم دوز هوشمند اضافه شده است.
  1. بررسی کنید که آیا مواد شوینده استفاده شده مناسب است.
     - → "مواد شوینده و محصولات مراقبتی"، صفحه 31
  2. محفظه را تخلیه کنید.
     - → "تمیز کردن کشوی مواد شوینده"، صفحه 43
  3. محفظه را تمیز کنید.
  4. محفظه را دوباره پر کنید.
     - → "پر کردن محفظه‌ها"، صفحه 36
- **علت:** دوز پایه به درستی تنظیم نشده است.
  - **راه‌حل:** اگر دوز هوشمند فعال است، دوز پایه را کاهش دهید.
    - → صفحه 37

**باقی‌مانده مواد شوینده روی لباس‌های خشک.**
- **علت:** مواد شوینده ممکن است حاوی مواد نامحلول در آب باشند که روی لباس‌ها رسوب می‌کنند.
  - **راه‌حل:** پس از شستشو و خشک کردن، لباس‌ها را برس بزنید.
- **علت:** مواد شوینده نامناسب به محفظه سیستم دوز هوشمند اضافه شده است.
  1. بررسی کنید که آیا مواد شوینده استفاده شده مناسب است.
     - → "مواد شوینده و محصولات مراقبتی"، صفحه 31
  2. محفظه را تخلیه کنید.
...
**تمیز کردن ناکافی.**
- **علت:** دوز پایه به درستی تنظیم نشده است.
  - **راه‌حل:** اگر دوز هوشمند فعال است، دوز پایه را تنظیم کنید.
    - → صفحه 37
...
**تمیز کردن ناکافی.**
- **علت:** مواد شوینده یا محصولات مراقبتی در محفظه‌های سیستم دوز هوشمند سفت شده‌اند.
  1. بررسی کنید که آیا مواد شوینده استفاده شده مناسب است.
     - → "مواد شوینده و محصولات مراقبتی"، صفحه 31
  2. محفظه را تخلیه کنید.
     - → "تمیز کردن کشوی مواد شوینده"، صفحه 43
...
**Home Connect به درستی کار نمی‌کند.**
- **علت:** دلایل مختلفی ممکن است وجود داشته باشد.
  - **راه‌حل:** به www.home-connect.com مراجعه کنید.

**اتصال به شبکه خانگی برقرار نمی‌شود.**
- **علت:** Wi-Fi خاموش است.
  - **راه‌حل:** Wi-Fi را روی دستگاه فعال کنید.
    - → "فعال کردن Wi-Fi روی دستگاه"، صفحه 39
- **علت:** Wi-Fi فعال است اما اتصال به شبکه خانگی برقرار نمی‌شود.
  1. اطمینان حاصل کنید که شبکه خانگی در دسترس است.
  2. دستگاه را دوباره به شبکه خانگی متصل کنید.
     - → "راه‌اندازی Home Connect"، صفحه 38

**آب از شلنگ ورودی آب نشت می‌کند.**
- **علت:** شلنگ ورودی آب به درستی/محکم متصل نشده است.
  1. شلنگ ورودی آب را به درستی متصل کنید.
     - → "اتصال شلنگ ورودی آب"، صفحه 14
  2. اتصال پیچ را محکم کنید.

**آب از شلنگ خروجی آب نشت می‌کند.**
- **علت:** شلنگ خروجی آب آسیب دیده است.
  - **راه‌حل:** شلنگ خروجی آب آسیب دیده را تعویض کنید.
- **علت:** شلنگ خروجی آب به درستی متصل نشده است.
  - **راه‌حل:** شلنگ خروجی آب را به درستی متصل کنید.
    - → "انواع اتصال خروجی آب"، صفحه 15

![alt text](image-36.png)

#### علت و رفع اشکال

**بوی نامطبوع در دستگاه ایجاد شده است.**
رطوبت و باقی‌مانده مواد شوینده ممکن است باعث تشکیل باکتری شوند.
- **راه‌حل:** "تمیز کردن درام"، صفحه 42
- **نکته:** اگر از دستگاه استفاده نمی‌کنید، درب و کشوی مواد شوینده را باز بگذارید تا آب باقی‌مانده تبخیر شود.

**لکه‌های مرطوب روی پارچه‌ها پس از پایان برنامه Iron Assist ایجاد شده‌اند.**
قطرات آب از درام یا درب، پارچه‌ها را مرطوب کرده‌اند. این قطرات ممکن است از بخار متراکم شده یا رطوبت باقی‌مانده از برنامه شستشوی قبلی باشند.
- **راه‌حل:** پارچه‌ها را اتو کنید یا آنها را آویزان کنید تا خشک شوند.

**آب از زیر درب نشت می‌کند.**
آلودگی روی درب یا واشر باعث نشت آب می‌شود.
- **راه‌حل:** درب و واشر را تمیز کنید.
...
**شرط:** پمپ تخلیه خالی باشد. → صفحه 44

1. **توجه!** خروج آب ممکن است باعث آسیب به مواد شود.
   - **نکته:** اگر از طریق شیشه آب می‌بینید، درب را باز نکنید.
   - با استفاده از یک ابزار، آزادسازی اضطراری را به سمت پایین بکشید و آزاد کنید.
   - **نتیجه:** قفل درب آزاد می‌شود.

2. دریچه نگهداری را وارد کرده و قفل کنید.
3. دریچه نگهداری را ببندید.

#### 21 حمل و نقل، نگهداری و دفع
**21.1 برداشتن دستگاه**

1. شیر آب را ببندید.
2. شیلنگ ورودی آب را خالی کنید.
3. دستگاه را به حالت آماده به کار ببرید.
   - → "قرار دادن دستگاه در حالت آماده به کار"، صفحه 34
4. دوشاخه دستگاه را از برق بکشید.
5. آب را تخلیه کنید.
   - → "تمیز کردن پمپ تخلیه"، صفحه 44
6. شیلنگ‌ها را جدا کنید.
7. مخازن را خالی کنید.

**21.2 قرار دادن پیچ‌های حمل و نقل**

برای جلوگیری از آسیب در حمل و نقل، دستگاه را با استفاده از پیچ‌های حمل و نقل ایمن کنید.
1. با استفاده از پیچ‌گوشتی، 4 درپوش را بردارید.
   - درپوش‌ها را نگه دارید.
2. 4 پیچ حمل و نقل را وارد کنید.
   - → "برداشتن پیچ‌های حمل و نقل"، صفحه 13

**21.3 استفاده مجدد از دستگاه**

- برای اطلاعات بیشتر، به
   - → "نصب و اتصال"، صفحه 12 و
   - → "شروع یک چرخه شستشوی خالی"، صفحه 20 مراجعه کنید.

![alt text](image-38.png)

#### 21.4 دفع دستگاه قدیمی

مواد خام ارزشمند می‌توانند با بازیافت مجدداً استفاده شوند.

**هشدار**
**خطر آسیب به سلامتی!**
کودکان می‌توانند خود را در دستگاه قفل کنند و جان خود را به خطر بیندازند.
- **نکته:** دستگاه را پشت درب نصب نکنید زیرا ممکن است درب دستگاه را مسدود کند یا مانع از باز شدن آن شود.
- **نکته:** در مورد دستگاه‌های غیرقابل استفاده، دوشاخه برق را از پریز بکشید. سپس سیم برق را قطع کنید و قفل درب دستگاه را به گونه‌ای خراب کنید که دیگر بسته نشود.

1. دستگاه را از برق بکشید.
2. سیم برق را قطع کنید.
3. دستگاه را به روش‌های سازگار با محیط زیست دفع کنید.
   - اطلاعات مربوط به روش‌های دفع فعلی از فروشنده متخصص یا مقامات محلی قابل دسترسی است.

این دستگاه مطابق با دستورالعمل اروپایی 2012/19/EU در مورد دستگاه‌های الکتریکی و الکترونیکی استفاده شده (پسماند دستگاه‌های الکتریکی و الکترونیکی - WEEE) برچسب‌گذاری شده است. این دستورالعمل چارچوبی برای بازگشت و بازیافت دستگاه‌های استفاده شده در سراسر اتحادیه اروپا تعیین می‌کند.

#### 22 خدمات مشتری

قطعات یدکی اصلی مرتبط با عملکرد دستگاه مطابق با دستورالعمل طراحی اکولوژیک مربوطه، برای مدت حداقل 10 سال از تاریخ عرضه دستگاه شما در منطقه اقتصادی اروپا از خدمات مشتری قابل تهیه است.

**نکته:** تحت شرایط ضمانت سازنده، استفاده از خدمات مشتری رایگان است. اطلاعات دقیق در مورد دوره ضمانت و شرایط ضمانت در کشور شما از خدمات پس از فروش، فروشنده شما یا وب‌سایت ما قابل دسترسی است.

اگر با خدمات مشتری تماس بگیرید، به شماره محصول (E-Nr.)، شماره تولید (FD) و شماره متوالی (Z-Nr.) دستگاه خود نیاز خواهید داشت. اطلاعات تماس خدمات مشتری در دفترچه راهنمای خدمات مشتری ضمیمه یا در وب‌سایت ما موجود است.

#### 22.1 شماره محصول (E-Nr.)، شماره تولید (FD) و شماره متوالی (Z-Nr.)

می‌توانید شماره محصول (E-Nr.)، شماره تولید (FD) و شماره متوالی (Z-Nr.) را روی پلاک مشخصات دستگاه پیدا کنید. بسته به مدل، پلاک مشخصات در مکان‌های زیر قرار دارد:
- داخل درب.
- داخل دریچه نگهداری.
- پشت دستگاه.
...
#### 22.2 گارانتی AQUA-STOP

علاوه بر ادعاهای ضمانت در برابر فروشنده تحت قرارداد خرید و علاوه بر ضمانت سازنده ما، ما جبران خسارت را تحت شرایط زیر ارائه می‌دهیم:
- اگر سیستم Aqua-Stop ما خراب شود و باعث آسیب آب شود، ما خسارت را برای کاربران خصوصی جبران خواهیم کرد. برای اطمینان از حفاظت از آسیب آب، دستگاه باید به منبع برق متصل باشد.
- ضمانت مسئولیت برای طول عمر دستگاه معتبر است.
- ادعا تحت ضمانت فقط در صورتی قابل انجام است که دستگاه به درستی نصب و با Aqua-Stop طبق دستورات ما متصل شده باشد؛ این شامل نصب صحیح تمدید Aqua-Stop (لوازم جانبی اصلی) نیز می‌شود. ضمانت ما شامل خطوط تأمین یا اتصالات معیوب تا اتصال Aqua-Stop به شیر نمی‌شود.
- اگر دستگاه شما با Aqua-Stop مجهز شده باشد، به طور اصولی می‌توانید دستگاه خود را در حین کار بدون نظارت بگذارید و شیر را بعد از آن باز نگه دارید. شیر تنها در صورتی باید بسته شود که برای مدت طولانی از خانه دور باشید، مثلاً در تعطیلات چند هفته‌ای.

#### یادداشت جزئیات دستگاه و شماره تلفن خدمات مشتری

برای یافتن سریع جزئیات دستگاه و شماره تلفن خدمات مشتری:
- شماره محصول (E-Nr.)
- شماره تولید (FD)
- شماره متوالی (Z-Nr.)

این اطلاعات را در یک مکان مطمئن یادداشت کنید.

![alt text](image-40.png)

#### 23 مقادیر مصرف

اطلاعات زیر مطابق با مقررات طراحی اکولوژیک اتحادیه اروپا ارائه شده است. مقادیر داده شده برای برنامه‌هایی غیر از Eco 40-60 فقط به صورت تقریبی هستند و مطابق با استاندارد EN60456 تعیین شده‌اند. برای این منظور، عملکرد دوزینگ خودکار غیرفعال شده است.

**نکته در مورد تست مقایسه:** عملکرد دوزینگ خودکار را غیرفعال کنید مگر اینکه این عملکرد موضوع تست باشد.

| برنامه | بار (کیلوگرم) | مدت زمان برنامه (ساعت:دقیقه) | مصرف انرژی (کیلووات ساعت/چرخه) | مصرف آب (لیتر/چرخه) | حداکثر دما (°C) | سرعت چرخش (دور در دقیقه) | رطوبت باقی‌مانده (%) |
|--------|---------------|-------------------------------|----------------------------------|----------------------|-----------------|--------------------------|----------------------|
| Eco 40-60 | 9.0 | 3:48 | 0.718 | 69.0 | 35 | 1257 | 53.00 |
| Eco 40-60 | 4.5 | 2:50 | 0.316 | 47.0 | 26 | 1400 | 53.00 |
| Eco 40-60 | 2.5 | 2:40 | 0.173 | 37.0 | 23 | 1400 | 53.00 |
| Cotton 20 °C | 9.0 | 3:21 | 0.450 | 93.0 | 24 | 1400 | 50.00 |
| Cotton 40 °C | 9.0 | 3:25 | 1.120 | 93.0 | 42 | 1400 | 50.00 |
| Cotton 60 °C | 9.0 | 3:25 | 1.950 | 93.0 | 64 | 1400 | 50.00 |
| Cotton 40 °C + Prewash | 9.0 | 3:55 | 1.200 | 101.0 | 42 | 1400 | 50.00 |
| Easy-Care 40 °C | 4.0 | 2:30 | 0.750 | 58.0 | 44 | 1200 | 35.00 |
| Quick Mix 40 °C | 4.0 | 1:05 | 0.660 | 43.0 | 42 | 1400 | 50.00 |
| Wool 30 °C | 2.0 | 0:41 | 0.210 | 41.0 | 23 | 800 | 30.00 |

**توجه:** به دلیل تأثیر فشار آب، سختی و دمای ورودی، دمای محیط، نوع، مقدار و آلودگی لباس‌ها، مواد شوینده استفاده شده، نوسانات در منبع تغذیه و عملکردهای اضافی انتخاب شده، مقادیر واقعی ممکن است با مقادیر اعلام شده متفاوت باشند.

**برنامه تست مطابق با دستورالعمل طراحی اکولوژیک اتحادیه اروپا و مقررات برچسب‌گذاری انرژی اتحادیه اروپا با آب سرد (15 °C)**
...
| ویژگی | مقدار |
|-------|-------|
| ارتفاع دستگاه | 84.5 سانتی‌متر |
| عرض دستگاه | 59.8 سانتی‌متر |
| عمق دستگاه | 59.0 سانتی‌متر |
| عمق دستگاه با درب بسته | 64.8 سانتی‌متر |
| عمق دستگاه با درب باز | 109.0 سانتی‌متر |
| وزن | 82.6 کیلوگرم |
| حداکثر بار | 9.0 کیلوگرم |
| ولتاژ اصلی | 220-240 ولت، 50-60 هرتز |
| حداقل حفاظت نصب | 10 آمپر |
| توان نامی | 2300 وات |
| مصرف برق در حالت آماده به کار | 0.50 وات |
| مصرف برق در حالت روشن | 0.50 وات |
| زمان تا تنظیم حالت آماده به کار شبکه (Wi-Fi) | 5 دقیقه |
| مصرف برق در حالت آماده به کار شبکه (Wi-Fi) | 2.00 وات |
| فشار آب | حداقل: 100 کیلوپاسکال (1 بار)، حداکثر: 1000 کیلوپاسکال (10 بار) |
| طول شیلنگ ورودی آب | 150 سانتی‌متر |
| طول شیلنگ خروجی آب | 150 سانتی‌متر |
| طول سیم برق | 160 سانتی‌متر |

این محصول شامل منابع نوری از کلاس بهره‌وری انرژی F است. این منابع نوری به عنوان قطعه یدکی در دسترس هستند و باید فقط توسط کارکنان متخصص آموزش دیده تعویض شوند.

برای اطلاعات بیشتر در مورد مدل خود، می‌توانید به صورت آنلاین به آدرس [https://eprel.ec.europa.eu/](https://eprel.ec.europa.eu/) مراجعه کنید. این آدرس وب به پایگاه داده رسمی محصولات EPREL اتحادیه اروپا متصل است. لطفاً دستورالعمل‌های جستجوی مدل را دنبال کنید. شناسه مدل از کاراکترهای قبل از اسلش در شماره محصول (E-Nr.) روی پلاک مشخصات تشکیل شده است. به طور متناوب، می‌توانید شناسه مدل را در خط اول برچسب انرژی اتحادیه اروپا نیز پیدا کنید.

#### 24.1 اطلاعات مربوط به نرم‌افزار آزاد و منبع باز

این محصول شامل اجزای نرم‌افزاری است که توسط دارندگان حق نسخه‌برداری به عنوان نرم‌افزار آزاد یا منبع باز مجوز داده شده‌اند.
اطلاعات مجوز قابل اجرا در دستگاه خانگی شما ذخیره شده است. همچنین می‌توانید اطلاعات مجوز قابل اجرا را از طریق برنامه Home Connect خود دسترسی پیدا کنید: "پروفایل -> اطلاعات قانونی -> اطلاعات مجوز".
می‌توانید اطلاعات مجوز را از وب‌سایت برند محصول دانلود کنید. (لطفاً در وب‌سایت محصول برای مدل دستگاه خود و اسناد اضافی جستجو کنید). به طور متناوب، می‌توانید اطلاعات مربوطه را از oss- درخواست کنید.



![alt text](image-42.png)

#### درخواست کد منبع آزاد و منبع باز

کد منبع به درخواست شما در دسترس قرار خواهد گرفت. لطفاً درخواست خود را به آدرس زیر ارسال کنید:
- **ایمیل:** ossrequest@bshg.com
- **آدرس پستی:** BSH Hausgeräte GmbH, Carl-Wery-Str. 34, 81739 Munich, Germany

**موضوع ایمیل:** "OSSREQUEST"

هزینه انجام درخواست شما به عهده شما خواهد بود. این پیشنهاد به مدت سه سال از تاریخ خرید یا حداقل تا زمانی که ما پشتیبانی و قطعات یدکی برای دستگاه مربوطه ارائه می‌دهیم، معتبر است.

#### 25 اعلامیه انطباق

BSH Hausgeräte GmbH بدین وسیله اعلام می‌کند که دستگاه با قابلیت Home Connect با الزامات اساسی و سایر مقررات مربوطه دستورالعمل 2014/53/EU مطابقت دارد.

اعلامیه انطباق RED دقیق را می‌توانید به صورت آنلاین در [www.bosch-home.com](https://www.bosch-home.com) در میان اسناد اضافی در صفحه محصول دستگاه خود پیدا کنید.

بدین وسیله، BSH Hausgeräte GmbH اعلام می‌کند که دستگاه با قابلیت Home Connect با الزامات قانونی مربوطه مطابقت دارد.

اعلامیه انطباق دقیق را می‌توانید به صورت آنلاین در [www.bosch-home.co.uk](https://www.bosch-home.co.uk) در میان اسناد اضافی در صفحه محصول دستگاه خود پیدا کنید.

**فقط برای بریتانیا:**
- باند 2.4 گیگاهرتز (2400–2483.5 مگاهرتز): حداکثر 100 میلی‌وات
- باند 5 گیگاهرتز (5150–5350 مگاهرتز + 5470–5725 مگاهرتز): حداکثر 150 میلی‌وات

**استفاده از WLAN 5 گیگاهرتز (Wi-Fi) فقط برای استفاده داخلی:**
- کشورهای مجاز: BE, BG, CZ, DK, DE, EE, IE, EL, ES, FR, HR, IT, CY, LI, LV, LT, LU, HU, MT, NL, AT, PL, PT, RO, SI, SK, FI, SE, NO, CH, TR, IS, UK (NI)
- کشورهای غیرمجاز: AL, BA, MD, ME, MK, RS, UK, UA
